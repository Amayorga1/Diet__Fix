        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    KetoDesc = table.Column<string>(nullable: true),
                    PaleoDesc = table.Column<string>(nullable: true),
                    PescDesc = table.Column<string>(nullable: true),
                    MediDesc = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
