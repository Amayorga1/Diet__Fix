...
namespace Diet__Fix.Controllers
{
    public class UserAccountsController : Controller
    {
        ...
        public UserAccountsController(Diet_FixContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,FullName,Age,MealLog,UserProgression")] UserAccount userAccount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FullName,Age,MealLog,UserProgression")] UserAccount userAccount)
        {
